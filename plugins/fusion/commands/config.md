---
description: Configure model defaults across the Claude, Grok, and Codex orchestration surfaces
allowed-tools: Read, Glob, Edit, Bash(grok models:*), Bash(rg:*), AskUserQuestion
---

Inspect the local model configuration across all peer engines, show what is currently available, and offer targeted edits to the defaults. Treat this as the write path counterpart to /fusion:doctor.
