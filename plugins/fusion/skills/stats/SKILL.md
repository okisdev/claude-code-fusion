...
argument-hint: '[--all] [--session [id]] [--trace] [--audit [--days <n>]] [--include-legacy] [--record-acceptance <job-id> <accepted|rejected|unverified>] [--record-worker-acceptance <task-id> <accepted|rejected|unverified>] [--json]'
