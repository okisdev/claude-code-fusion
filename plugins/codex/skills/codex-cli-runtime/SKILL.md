...
- A foreground `--write --model gpt-5.6-sol` task emits a nonblocking warning before execution and records it as a diagnostic: 41% of those tasks timed out in the last 7 days. Split the package or use `gpt-5.6-terra`.
