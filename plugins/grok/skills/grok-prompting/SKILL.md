...
- Include context generously. Grok has a 512k window; err on the side of pasting relevant code, error output, and prior findings rather than referring to them.
