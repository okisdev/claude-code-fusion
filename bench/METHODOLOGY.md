...
- condition notes: filesystem detected condition hints, including installed plugin names when the runner can cheaply detect them in the isolated Claude configuration directory.
